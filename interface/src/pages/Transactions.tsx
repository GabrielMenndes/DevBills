...
const Transactions = () => {
  ...
  const fetchTransactions = async (): Promise<void> => {
    try {
      ...
      setError("Ocorreu um erro ao carregar as transações. Por favor, tente novamente.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <Card className=" overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 mb-4">Nenhuma transação encontrada para este período.</p>
            <Link
              to="/transacoes/nova"
