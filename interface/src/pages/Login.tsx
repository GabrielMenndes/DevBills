      ...
      <div className="max-w-md w-full space-y-8">
        <header>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Gerencie Finanças de Fo Simples e Eficiee!
          </p>
        </header>
        ...
        <main className="mt-8 bg-white py-8 px-4 shadow-md rounded-lg sm:px-10 space-y-6">
          ...
          {authState.error && (
            <div className="bg-red-50 text-center text-red-700 mt-4">
              <p>O login foi cancelado. Tente novamente.</p>
            </div>
          )}

          <footer className="mt-6">
            <p className="mt-1 text-sm text-gray-600 text-center">
              Ao fazer login, você concorda com nossos termos uso e política de privacidade.
            </p>
          </footer>
        </main>
      </div>
